...
THEME_TITLE="PolicyFlow Admin Theme"
...
name: '$THEME_TITLE'
type: theme
description: 'A custom Drupal theme for PolicyFlow admin portal.'
...
{
  "name": "policyflow/admin-theme",
  "description": "Drupal theme for PolicyFlow admin portal",
  "type": "drupal-theme",
  "license": "Apache-2.0",
